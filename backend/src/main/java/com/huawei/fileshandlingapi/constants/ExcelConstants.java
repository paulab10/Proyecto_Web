...
public class ExcelConstants {
    ...
    public static final String COOPERADOR = "Supplier Name";
    ...
    public static final String PO_IBUY_CANT = "PO Line iBuy Accepted Qty";
    public static final String PO_ERP_CANT = "PO Line ERP Accepted Qty";
    public static final String PO_BILLED = "PO Line Billed Qty";

    public static final int PO_NUMBER_INDEX = 0;
    public static final int SPR_INDEX = 1;
    public static final int ITEM_CODE_INDEX = 2;
    public static final int STATUS_INDEX = 3;
    public static final int QUANTITY_INDEX = 4;
